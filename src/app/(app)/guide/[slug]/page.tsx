...
import { Rubrique07Page } from "@/components/guide/rubrique-07-page";
import { Rubrique08Page } from "@/components/guide/rubrique-08-page";
import { Rubrique09Page } from "@/components/guide/rubrique-09-page";
import { Rubrique10Page } from "@/components/guide/rubrique-10-page";
...
export default async function GuideRubriquePage({
  ...
  if (rubrique.id === "03") {
    return <Rubrique03Page rubrique={rubrique} />;
  }
  if (rubrique.id === "04") {
    return <Rubrique04Page rubrique={rubrique} />;
  }
  if (rubrique.id === "05") {
  ...
  if (rubrique.id === "07") {
    return <Rubrique07Page rubrique={rubrique} />;
  }
  if (rubrique.id === "08") {
    return <Rubrique08Page rubrique={rubrique} />;
  }
  if (rubrique.id === "09") {
    return <Rubrique09Page rubrique={rubrique} />;
  }
  if (rubrique.id === "10") {
    return <Rubrique10Page rubrique={rubrique} />;
  }
